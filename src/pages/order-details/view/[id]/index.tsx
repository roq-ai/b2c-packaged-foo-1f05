...
import { useOrderDetailFindFirst, useRoqClient } from 'lib/roq';
...
function OrderDetailViewPage() {
  ...
  const queryParams = useMemo<{ include: { order: boolean; inventory: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useOrderDetailFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('order_detail', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/order-details/edit/${id}`} passHref legacyBehavior>
                    <Button

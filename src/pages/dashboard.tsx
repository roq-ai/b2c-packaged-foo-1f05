...
import { useRoqPlatformUserProfiles, useReviewCount, useInventoryCount, useCartCount } from 'lib/roq';

import { AddressListPage as ShowCaseList } from 'pages/addresses';
          ...
          <Stack direction="column" spacing={8} flex={{ base: 1, md: 7 }}>
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                ...
                <NextLink href={`addresses`} passHref legacyBehavior>
                  <Button

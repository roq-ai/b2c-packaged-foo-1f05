...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`B2C Packaged Food selling`}</title>

        <meta
          name="description"
          content="B2C Packaged Food Selling - Your One-Stop Shop for Ordering Packaged Food Online, with Hassle-Free Inventory Management by Us"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1573256843536-2e3f595c28e4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwYWNrYWdlZCUyMGZvb2R8ZW58MHx8fHwxNjk4ODYyOTc1fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@bentofan?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Ben Tofan`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`B2C Packaged Food selling`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`B2C Packaged Food Selling - Your One-Stop Shop for Ordering Packaged Food Online, with Hassle-Free Inventory Management by Us`}
            </Text>
            <Box

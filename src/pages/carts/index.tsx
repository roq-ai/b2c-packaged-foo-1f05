...
import { useRoqClient, useCartFindManyWithCount } from 'lib/roq';
...
export function CartListPage(props: CartListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useCartFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.cart.delete({ where: { id } });
      await mutate();
    } catch (error) {

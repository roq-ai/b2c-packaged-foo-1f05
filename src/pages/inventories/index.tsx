...
export function InventoryListPage(props: InventoryListPageProps) {
  ...
  const queryParams = useMemo(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['vendor', 'order_detail.count', 'review.count'],
          searchTerm: params.searchTerm,
          searchTermKeys: [
            'product_name.contains',
            'product_description.contains',
            'inventory_category.contains',
            'sub_category.contains',
          ],
          ...params.filters,
        },
        'inventory',
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'inventory_category', header: 'Inventory Category', accessorKey: 'inventory_category' },
    { id: 'sub_category', header: 'Sub Category', accessorKey: 'sub_category' },
    hasAccess('vendor', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('order_detail', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'order_detail',
          header: 'Order Detail',
          accessorKey: 'order_detail',
          cell: ({ row: { original: record } }: any) => record?._count?.order_detail,
        }
      : null,

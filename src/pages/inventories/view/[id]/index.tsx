...
import { OrderDetailListPage } from 'pages/order-details';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Inventory Category" text={data?.inventory_category} />

                <FormListItem label="Sub Category" text={data?.sub_category} />

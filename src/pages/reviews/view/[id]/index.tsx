...
function ReviewViewPage() {
  ...
  const queryParams = useMemo<{ include: { user: boolean; vendor: boolean; inventory: boolean } }>(
    () =>
      convertQueryToPrismaUtil(
        {
          relations: ['user', 'vendor', 'inventory'],
          id,
        },
        'review',
      ),
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Review Rating" text={data?.review_rating} />
